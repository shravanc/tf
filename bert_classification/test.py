...
OUTPUT_DIR = '/home/shravan/tf/all_models/model_1'
...
from lib.utils import load_directory_data, load_dataset, download_and_load_datasets

force_download = False
train, test = download_and_load_datasets(force_download)
print(train.head())

train = train.sample(32)
test  = test.sample(32)
#print(train.head())
...
BERT_MODEL_HUB = "https://tfhub.dev/tensorflow/bert_multi_cased_L-12_H-768_A-12/1"
