...
def create_model(bert_config, is_training, input_ids, input_mask, segment_ids,
  ...
  print("Hello am here now******************")
  #pooled_output, sequence_output = modeling.BertModel(config=bert_config)(
  pooled_output, sequence_output = modeling.BertModel(config=bert_config, is_training=is_training, input_ids=input_ids,
    input_mask=input_mask,)
...
def model_fn_builder(bert_config, init_checkpoint, learning_rate,
  ...
  def model_fn(features, labels, mode, params):  # pylint: disable=unused-argument
    ...
    print("****features====>", features, "IS_TRAINING-------------->", is_training)
    print("***>input_ids--->", input_ids)

    #def create_model(bert_config, is_training, input_ids, input_mask, segment_ids,
    create_model(bert_config, False, input_ids, input_mask, segment_ids,use_one_hot_embeddings)

#    (start_logits, end_logits, answer_type_logits) = create_model( bert_config=bert_config, is_training=False, input_ids=input_ids, input_mask=input_mask, segment_ids=segment_ids, use_one_hot_embeddings=use_one_hot_embeddings)
