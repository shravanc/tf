...
base_model = tf.keras.Sequential([
    # 1
    tf.keras.layers.Dense(608, activation=activation, kernel_regularizer=regularizers.l2(0.007)),
    # tf.keras.layers.Dropout(0.3),

    # 2
    tf.keras.layers.Dense(1024, activation=activation, kernel_regularizer=regularizers.l2(0.009)),
    # tf.keras.layers.Dropout(0.2),

    # 3
    tf.keras.layers.Dense(224, activation=activation, kernel_regularizer=regularizers.l2(0.003)),
    tf.keras.layers.Dropout(0.2),

    # 4
    tf.keras.layers.Dense(704, activation=activation, kernel_regularizer=regularizers.l2(0.0006)),
    tf.keras.layers.Dropout(0.4),

    # 5
    tf.keras.layers.Dense(64, activation=activation, kernel_regularizer=regularizers.l2(0.001)),
    tf.keras.layers.Dropout(0.3),

    tf.keras.layers.Dense(928, activation=activation, kernel_regularizer=regularizers.l2(0.002)),
    tf.keras.layers.Dropout(0.2),
