...
base_model = tf.keras.Sequential([
    # 1
    tf.keras.layers.Dense(416, activation=activation),
    ...
    # 3
    tf.keras.layers.Dense(768, activation=activation),
    ...
    # 6
    tf.keras.layers.Dense(160, activation=activation),
    tf.keras.layers.Dropout(0.1),
    ...
    # 8
    tf.keras.layers.Dense(320, activation=activation),
...
# base_model = tf.keras.Sequential([
#     # 1
#     tf.keras.layers.Dense(416, activation=activation, kernel_regularizer=regularizers.l2(0.001)),
#     tf.keras.layers.Dropout(0.4),
#
#     # 2
#     tf.keras.layers.Dense(128, activation=activation, kernel_regularizer=regularizers.l2(0.001)),
#     tf.keras.layers.Dropout(0.1),
#
#     # 3
#     tf.keras.layers.Dense(768, activation=activation, kernel_regularizer=regularizers.l2(0.001)),
#     tf.keras.layers.Dropout(0.5),
#
#     # 4
#     tf.keras.layers.Dense(192, activation=activation, kernel_regularizer=regularizers.l2(0.001)),
#     # tf.keras.layers.Dropout(0.5),
#
#     # 4
#     tf.keras.layers.Dense(416, activation=activation, kernel_regularizer=regularizers.l2(0.001)),
...
#
#     # 7
#     tf.keras.layers.Dense(512, activation=activation, kernel_regularizer=regularizers.l2(0.001)),
#     # tf.keras.layers.Dropout(0.1),
#
#     # 8
#     tf.keras.layers.Dense(320, activation=activation, kernel_regularizer=regularizers.l2(0.001)),
#     tf.keras.layers.Dropout(0.2),
#
#     tf.keras.layers.Dense(1)
# ])
