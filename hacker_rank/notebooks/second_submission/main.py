...
base_model = tf.keras.Sequential([
    tf.keras.layers.Dense(96, activation=LeakyReLU(alpha=0.1)),
    tf.keras.layers.Dropout(0.5),

    tf.keras.layers.Dense(384, activation=LeakyReLU(alpha=0.1)),
    tf.keras.layers.Dropout(0.5),
    ...
    tf.keras.layers.Dense(352, activation=LeakyReLU(alpha=0.1)),
    tf.keras.layers.Dropout(0.5),

    tf.keras.layers.Dense(448, activation=LeakyReLU(alpha=0.1)),
