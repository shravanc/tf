...
base_model = tf.keras.Sequential([
    # 1
    tf.keras.layers.Dense(352, activation=activation),
    tf.keras.layers.Dropout(0.2),

    # 2
    tf.keras.layers.Dense(864, activation=activation),
    ...
    # 5
    tf.keras.layers.Dense(960, activation=activation),
    tf.keras.layers.Dropout(0.1),

    # 5
    tf.keras.layers.Dense(576, activation=activation),
    tf.keras.layers.Dropout(0.4),
    ...
    # 5
    tf.keras.layers.Dense(896, activation=activation),
    tf.keras.layers.Dropout(0.2),
    ...
    # 5
    tf.keras.layers.Dense(448, activation=activation),
    ...
    # 5
    tf.keras.layers.Dense(384, activation=activation),
    tf.keras.layers.Dropout(0.3),
    ...
    # 5
    tf.keras.layers.Dense(704, activation=activation),
    tf.keras.layers.Dropout(0.4),

    # 5
    tf.keras.layers.Dense(544, activation=activation),
    tf.keras.layers.Dropout(0.3),
...
for row in test_data:
    ...
    pd = row[np.newaxis] #.values[np.newaxis]
